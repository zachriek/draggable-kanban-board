...
import { ColumnColorScheme } from '../utils/colors';

type TaskProps = {
  index: number;
  task: ITaskModel;
  onUpdate: (id: ITaskModel['id'], updatedTask: ITaskModel) => void;
  onDelete: (id: ITaskModel['id']) => void;
  ...
  return (
    <ScaleFade in={true} unmountOnExit>
      <Box
        ...
        fontWeight="bold"
        userSelect="none"
        bgColor={`${ColumnColorScheme[task.column]}.100`}
